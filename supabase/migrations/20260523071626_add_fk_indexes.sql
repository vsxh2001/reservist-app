...
-- Note: slots.assigned_by lived on the slot_assignees join table, which
-- 20260518185825_slots_individual.sql dropped when it moved slots to a
-- single assignee_id column — no `assigned_by` column to index on slots.
